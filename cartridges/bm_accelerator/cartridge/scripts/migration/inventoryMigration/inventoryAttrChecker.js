...
var SFCC_OBJECT_TYPE    = 'ProductInventoryRecord';
...
/**
 * Fetch custom field definitions for inventory-entry resource type from CTP Types API.
 * @returns {Array}
 */
function getCtpInventoryFields() {
    var c   = cfg.ctp;
    var tok = getCtpToken();
    var qs  = '?where=' + encodeURIComponent('resourceTypeIds contains any ("inventory-entry")') + '&limit=500';
...
/**
 * Compare CTP inventory-entry fields against SFCC ProductInventoryRecord attributes.
 * @returns {Array}
 */
function checkMissingAttributes() {
    ...
    var missing = [];
    var seen    = {};
    var ctpFields = getCtpInventoryFields();
...
/**
 * Create attribute definitions on SFCC ProductInventoryRecord.
 * @param {Array} attrs
