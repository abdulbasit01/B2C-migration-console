...
/**
 * Fetch custom field definitions for order resource type from CTP Types API.
 * @returns {Array}
 */
...
/**
 * Compare CTP order custom fields against SFCC Order attribute definitions.
 * @returns {Array}
 */
function checkMissingAttributes() {
    ...
    var missing = [];
    var seen    = {};
    var ctpFields = getCtpOrderFields();
    var i;
...
/**
 * Create attribute definitions on SFCC Order system object.
 * @param {Array} attrs
