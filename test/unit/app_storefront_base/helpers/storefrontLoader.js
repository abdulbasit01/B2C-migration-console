...
/**
 * Resolve app_storefront_base cartridge module paths for Node/Mocha unit tests.
 */
var Module = require('module');
var path   = require('path');
var fs     = require('fs');

var CARTRIDGE_ROOT = path.resolve(__dirname, '../../../../cartridges/app_custom_amplience/cartridge');
